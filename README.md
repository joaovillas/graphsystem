...
GET: `/api/v1/grafo/node/{nodeId}`

---

4 - How to remove a node?  
GET: `/api/v1/grafo/node/remove/{nodeId}`

---

5 - How to see the degree of a node?  
GET: `/api/v1/grafo/node/degree/{nodeId}`

---

6 - How to test connections between two nodes?  
GET: `/api/v1/grafo/node/connection/{nodeId}&{targetId}`

---

7 - How to see the adjacent graphs?  
GET: `/api/v1/grafo/node/adjacent/{nodeId}`

---

8 - How to INSERT a connection between two nodes?  
GET: `/api/v1/grafo/node/connection/connect/{nodeId}&{targetId}[&{weight}]`
